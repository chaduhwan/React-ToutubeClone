    ...
    return (
        <div className='NaviMain'>
            ...
            <div className='linkcon'>
                <div>
                    <p>정보</p> <p>보도자료</p> <p>저작권</p> <p>문의하기</p> <p>크리에이터</p> <p>광고</p> <p>개발자</p>
                </div>
                ...
                <p>약관</p> <p>개인정보처리방침</p> 
                    ...
                    © 2023 Google LLC, Sundar Pichai, 1600 Amphitheatre Parkway, Mountain View CA 94043, USA, 0807-882-594 (무료), yt-support-solutions-kr@google.com, 호스팅: Google LLC, <p className='p'>사업자정보, 불법촬영물 신고</p>
